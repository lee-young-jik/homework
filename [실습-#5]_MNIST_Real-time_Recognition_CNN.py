...
model = tf.keras.models.Sequential([
        tf.keras.layers.Conv2D(input_shape = (28,28,1),kernel_size=(3,3),filters=32,activation='relu'),
...
#%%
model.save_weights('./mnist_cnn/mnist_cnn_checkpoint')
...
#%%
print("loading model")
model.load_weights('./mnist_cnn/mnist_cnn_checkpoint')
